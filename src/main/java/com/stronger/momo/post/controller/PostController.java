...
public class PostController {
    ...
    @PostMapping("/write")
    public ResponseEntity<?> writePost(Authentication authentication, @RequestBody SnsCreateDto dto) {
    ...
    @PutMapping("/update")
    public ResponseEntity<?> updatePost(Authentication authentication, @RequestBody SnsCreateDto dto) throws AccessDeniedException {
